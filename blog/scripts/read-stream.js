...
hexo.extend.tag.register('readItems', function(args){
  ...
  var placeholder = imgUrl;
  var title = args.shift();

  var result = '<readItems style="text-align: center;">';
  result += '<a href="' + wordUrl + '" target="_blank" rel="external">'
  result += '<img class="hexo-image-stream-lazy noswiper" src="' + placeholder + '" data-original="' + imgUrl + '"/>';
